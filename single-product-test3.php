...
jQuery(document).ready(function($) {
    ...
    function updateDecorPrice(groupId, price, quantity, optionTitle) {
        ...
        // Обновляем название, если передан optionTitle
    ...
    $(document).on('change', '.options_block:not(.third_type) .option_button', function() {
        ...
        // Получаем выбранное значение (название опции) - берем первый текстовый элемент
        var selectedValue = '';
        ...
        // Ищем существующий блок в синей плашке
        ...
        if ($orderOption.length) {
            ...
            // Обновляем название (добавляем выбранное значение)
